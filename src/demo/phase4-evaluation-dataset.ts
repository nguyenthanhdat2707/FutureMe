  ...
  for (const persona of personas) {
    ...
    if (persona.slug === 'focused-builder') {
      ...
      const additionalEvents: Parameters<typeof addCalendar>[] = [
        ...
        // Extra past-day density: 30 more events (p7b-p1d) → total 90
        ['p7b-1on1', '1:1 with Lead', wd(-7, 4), wd(-7, 4, 30), 'meeting'],
        ['p7c-qa', 'QA Sign-off', wd(-7, 7), wd(-7, 8), 'meeting'],
        ['p7d-debrief', 'Sprint Debrief', wd(-7, 9), wd(-7, 9, 30), 'other'],
        ['p7e-focus', 'Late Focus Block', wd(-7, 9, 30), wd(-7, 11), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'release' }],
        ['p6b-1on1', '1:1 with PM', wd(-6, 4), wd(-6, 4, 30), 'meeting'],
        ['p6c-review', 'API Design Review', wd(-6, 7), wd(-6, 8, 30), 'meeting'],
        ['p6d-focus', 'Refactor deep work', wd(-6, 8, 30), wd(-6, 10), 'deep_work'],
        ['p6e-wrap', 'Daily wrap-up', wd(-6, 10), wd(-6, 10, 30), 'other'],
        ['p5b-1on1', '1:1 with Tech Lead', wd(-5, 4), wd(-5, 4, 30), 'meeting'],
        ['p5c-deploy', 'Staging Deploy', wd(-5, 5, 30), wd(-5, 6, 30), 'meeting', 'https://meet.example.com/phase4-focused-builder-deploy'],
        ['p5d-focus2', 'Afternoon release tests', wd(-5, 8, 30), wd(-5, 10), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'release' }],
        ['p5e-admin', 'Ticket triage', wd(-5, 10), wd(-5, 10, 30), 'other'],
        ['p4b-1on1', '1:1 with Manager', wd(-4, 4), wd(-4, 4, 30), 'meeting'],
        ['p4c-security', 'Security Review', wd(-4, 7), wd(-4, 8), 'meeting'],
        ['p4d-debug', 'Memory-leak debug session', wd(-4, 8), wd(-4, 10), 'deep_work'],
        ['p4e-retro', 'Sprint retrospective', wd(-4, 10), wd(-4, 11), 'meeting'],
        ['p3b-1on1', '1:1 with stakeholder', wd(-3, 4), wd(-3, 4, 30), 'meeting'],
        ['p3c-perf', 'Performance testing', wd(-3, 5, 30), wd(-3, 6, 30), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'release' }],
        ['p3d-demo', 'Internal demo prep', wd(-3, 8), wd(-3, 9), 'meeting'],
        ['p3e-docs', 'Release notes drafting', wd(-3, 9), wd(-3, 10), 'other'],
        ['p2b-1on1', '1:1 Engineering Lead', wd(-2, 4), wd(-2, 4, 30), 'meeting'],
        ['p2c-cr', 'Code Review round 2', wd(-2, 7), wd(-2, 8, 30), 'meeting'],
        ['p2d-fix', 'Bug fix sprint', wd(-2, 8, 30), wd(-2, 10, 30), 'deep_work'],
        ['p2e-plan', 'Release cut planning', wd(-2, 10, 30), wd(-2, 11), 'meeting'],
        ['p1b-1on1', '1:1 PM sync', wd(-1, 4), wd(-1, 4, 30), 'meeting'],
        ['p1c-staging', 'Staging smoke test', wd(-1, 5, 30), wd(-1, 6, 30), 'meeting'],
        ['p1d-focus', 'Final RC hardening', wd(-1, 8, 30), wd(-1, 10), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'release', focusQuality: 'HIGH' }],
        ['p1e-admin', 'Deploy checklist review', wd(-1, 10), wd(-1, 10, 30), 'other'],
        // Extra current-week events
        ['mon-deep2', 'Afternoon release focus', wd(0, 8), wd(0, 10), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'release' }],
        ['tue-deep2', 'Afternoon implementation', wd(1, 9), wd(1, 10, 30), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'release' }],
      ];
      ...
      const additionalEvents: Parameters<typeof addCalendar>[] = [
        ...
        // Extra past-day density: 35 more events → total 115
        ['p7b-partner', 'Partner Pipeline Call', wd(-7, 4), wd(-7, 5), 'meeting', 'https://meet.example.com/phase4-busy-standup'],
        ['p7c-pitch', 'Pitch Evidence Review', wd(-7, 6), wd(-7, 7, 30), 'deep_work'],
        ['p7d-client', 'Client Onboarding Call', wd(-7, 7, 30), wd(-7, 8, 30), 'meeting'],
        ['p7e-social', 'Founder Dinner (Optional)', wd(-7, 12), wd(-7, 13, 30), 'other', undefined, 'CONFIRMED', { flexibility: 'OPTIONAL', priority: 'LOW', consequence: 'LOW' }],
        ['p6b-investor', 'Investor Introduction', wd(-6, 3, 30), wd(-6, 4, 30), 'meeting'],
        ['p6c-market', 'Market Analysis deep work', wd(-6, 5), wd(-6, 7), 'deep_work'],
        ['p6d-pitch2', 'Pitch Narrative Draft', wd(-6, 7, 30), wd(-6, 9), 'deep_work'],
        ['p6e-networking', 'Accelerator Networking Event (Optional)', wd(-6, 11), wd(-6, 12, 30), 'recovery', undefined, 'CONFIRMED', { flexibility: 'OPTIONAL', priority: 'LOW', consequence: 'LOW' }],
        ['p5b-customer', 'Customer Discovery Call', wd(-5, 4), wd(-5, 5), 'meeting'],
        ['p5c-slides', 'Pitch Deck Slides', wd(-5, 6), wd(-5, 8), 'deep_work'],
        ['p5d-sync', 'Co-founder Check-in', wd(-5, 8, 30), wd(-5, 9), 'meeting'],
        ['p5e-admin', 'Expense Reports & Admin', wd(-5, 9), wd(-5, 9, 30), 'other', undefined, 'CONFIRMED', { flexibility: 'MOVABLE', priority: 'LOW', consequence: 'LOW' }],
        ['p4b-boardprep', 'Board Update Prep', wd(-4, 3, 30), wd(-4, 5), 'deep_work'],
        ['p4c-call', 'Strategic Partner Call', wd(-4, 5, 30), wd(-4, 6, 30), 'meeting'],
        ['p4d-review', 'Product Sprint Review', wd(-4, 7), wd(-4, 8), 'meeting'],
        ['p4e-social', 'Team Social (Optional)', wd(-4, 12), wd(-4, 13), 'recovery', undefined, 'CONFIRMED', { flexibility: 'OPTIONAL', priority: 'LOW', consequence: 'LOW' }],
        ['p3b-investor2', 'Follow-up Investor Call', wd(-3, 3, 30), wd(-3, 4, 30), 'meeting'],
        ['p3c-dw2', 'Customer Proposal deep work', wd(-3, 5), wd(-3, 7), 'deep_work'],
        ['p3d-hiring', 'Hiring Interview', wd(-3, 7, 30), wd(-3, 8, 30), 'meeting'],
        ['p3e-admin', 'Contract Review', wd(-3, 9), wd(-3, 9, 30), 'other'],
        ['p2b-pitch', 'Pitch Rehearsal', wd(-2, 3, 30), wd(-2, 5), 'deep_work'],
        ['p2c-customer', 'Customer Account Sync', wd(-2, 6), wd(-2, 7), 'meeting'],
        ['p2d-legal', 'Legal & Contracts Review', wd(-2, 7, 30), wd(-2, 8, 30), 'other'],
        ['p2e-planning', 'Weekly founder planning (Movable)', wd(-2, 9), wd(-2, 10), 'meeting', undefined, 'CONFIRMED', { flexibility: 'MOVABLE', priority: 'LOW', consequence: 'LOW' }],
        ['p1b-prep', 'Competition prep deep work', wd(-1, 3, 30), wd(-1, 5, 30), 'deep_work'],
        ['p1c-call', 'Warm Lead Call', wd(-1, 6), wd(-1, 7), 'meeting'],
        ['p1d-1on1', '1:1 Co-founder', wd(-1, 7, 30), wd(-1, 8), 'meeting'],
        ['p1e-wrap', 'EOD wrap + logistics', wd(-1, 10, 30), wd(-1, 11), 'other'],
        // current-week extra
        ['mon-deep2', 'Afternoon pitch prep', wd(0, 8, 30), wd(0, 10), 'deep_work'],
        ['tue-dw2', 'Revenue forecast', wd(1, 9), wd(1, 10), 'deep_work'],
        ['thu-debrief', 'EOD prep debrief', wd(3, 10), wd(3, 10, 30), 'other'],
        ['sat-long-run', 'Morning run (recovery)', wd(5, 0, 30), wd(5, 2), 'recovery'],
        ['sun-journaling', 'Weekly reflection (Optional)', wd(6, 12), wd(6, 13), 'other', undefined, 'CONFIRMED', { flexibility: 'OPTIONAL', priority: 'LOW', consequence: 'LOW' }],
      ];
      for (const event of additionalEvents) addCalendar(...event);
      ...
      const additionalEvents: Parameters<typeof addCalendar>[] = [
        ...
        // Extra past-day density: 35 more events → total 100
        ['p7b-1on1a', '1:1 with Senior Engineer', wd(-7, 4), wd(-7, 4, 30), 'meeting'],
        ['p7c-roadmap', 'Roadmap Prioritization', wd(-7, 6), wd(-7, 7, 30), 'meeting'],
        ['p7d-focus', 'Technical deep work (rare)', wd(-7, 8), wd(-7, 9), 'deep_work'],
        ['p7e-oncall', 'On-call handoff', wd(-7, 9, 30), wd(-7, 10), 'other'],
        ['p6b-1on1b', '1:1 with Designer', wd(-6, 4), wd(-6, 4, 30), 'meeting'],
        ['p6c-hiring2', 'Hiring Debrief', wd(-6, 6, 30), wd(-6, 7, 30), 'meeting'],
        ['p6d-perf', 'Performance Monitoring Review', wd(-6, 8), wd(-6, 9), 'meeting'],
        ['p6e-email', 'Exec Email Triage', wd(-6, 10), wd(-6, 10, 30), 'other'],
        ['p5b-sprint', 'Sprint Kickoff', wd(-5, 2, 30), wd(-5, 4), 'meeting'],
        ['p5c-1on1c', '1:1 with Product Lead', wd(-5, 4, 30), wd(-5, 5), 'meeting'],
        ['p5d-escalation', 'Customer Escalation Call', wd(-5, 6), wd(-5, 7, 30), 'meeting'],
        ['p5e-dw', 'Architecture planning', wd(-5, 8), wd(-5, 9), 'deep_work'],
        ['p4b-1on1d', '1:1 with QA Lead', wd(-4, 4), wd(-4, 4, 30), 'meeting'],
        ['p4c-ops', 'Ops Review', wd(-4, 5), wd(-4, 6), 'meeting'],
        ['p4d-investor2', 'Investor Update Draft', wd(-4, 7), wd(-4, 8, 30), 'deep_work'],
        ['p4e-slack', 'Async Slack catch-up', wd(-4, 10), wd(-4, 10, 30), 'other'],
        ['p3b-1on1e', '1:1 Gamma', wd(-3, 4), wd(-3, 4, 30), 'meeting'],
        ['p3c-cr', 'Cross-team Code Review', wd(-3, 5, 30), wd(-3, 6, 30), 'meeting'],
        ['p3d-proposal', 'Customer Proposal Draft', wd(-3, 7), wd(-3, 8, 30), 'deep_work'],
        ['p3e-triage', 'Incident Post-mortem', wd(-3, 9), wd(-3, 10), 'meeting'],
        ['p2b-1on1f', '1:1 Alpha', wd(-2, 4), wd(-2, 4, 30), 'meeting'],
        ['p2c-backlog', 'Backlog Grooming', wd(-2, 6), wd(-2, 7, 30), 'meeting'],
        ['p2d-exec', 'Exec Briefing Prep', wd(-2, 8), wd(-2, 9), 'deep_work'],
        ['p2e-deploy', 'Hotfix Deploy', wd(-2, 9, 30), wd(-2, 10, 30), 'meeting'],
        ['p1b-leadership', 'Leadership Team Sync', wd(-1, 2, 30), wd(-1, 4), 'meeting'],
        ['p1c-1on1g', '1:1 Beta', wd(-1, 4, 30), wd(-1, 5), 'meeting'],
        ['p1d-customer', 'Customer QBR Prep', wd(-1, 6), wd(-1, 7, 30), 'deep_work'],
        ['p1e-planning', 'Sprint Planning', wd(-1, 8), wd(-1, 9, 30), 'meeting'],
        // current-week morning density (no Wed afternoon for overloaded-lead)
        ['mon-1on1h', '1:1 Delta', wd(0, 4, 30), wd(0, 5), 'meeting'],
        ['mon-roadmap2', 'Roadmap sync', wd(0, 7), wd(0, 8), 'meeting'],
        ['tue-hiring3', 'Hiring Panel Interview', wd(1, 6, 30), wd(1, 7, 30), 'meeting'],
        ['wed-1on1i', '1:1 Epsilon', wd(2, 4, 30), wd(2, 5), 'meeting'],
        ['thu-postmortem', 'Emergency Post-mortem', wd(3, 9), wd(3, 10), 'meeting'],
        ['fri-board', 'Board Update Prep', wd(4, 2), wd(4, 4), 'deep_work'],
      ];
      for (const event of additionalEvents) addCalendar(...event);
      ...
      const additionalEvents: Parameters<typeof addCalendar>[] = [
        ...
        // Extra past-day density: 25 more events → total 85
        // CONSTRAINT: NO day-2 (Wednesday) events; max 2 Thursday (day 3) events already set
        ['p7b-class', 'Database Systems Lecture', wd(-7, 1), wd(-7, 2, 30), 'meeting'],
        ['p7c-study', 'Certification Practice Test', wd(-7, 3), wd(-7, 5), 'deep_work'],
        ['p7d-group', 'Study Group Session', wd(-7, 8), wd(-7, 9, 30), 'meeting'],
        ['p6b-lecture', 'Networks Lecture', wd(-6, 1), wd(-6, 2, 30), 'meeting'],
        ['p6c-certprep', 'Cert mock exam practice', wd(-6, 3), wd(-6, 5), 'deep_work'],
        ['p6d-part-time', 'Part-time Work Shift', wd(-6, 6), wd(-6, 9), 'other'],
        ['p5b-class', 'Cloud Computing Lecture', wd(-5, 1), wd(-5, 2, 30), 'meeting'],
        ['p5c-assign', 'Assignment research block', wd(-5, 3), wd(-5, 5, 30), 'deep_work'],
        ['p5d-parttime2', 'Part-time Work Shift', wd(-5, 6), wd(-5, 9), 'other'],
        ['p4b-collab', 'Hackathon team standup', wd(-4, 2), wd(-4, 2, 30), 'meeting'],
        ['p4c-certprep2', 'Cert chapter review', wd(-4, 3), wd(-4, 5), 'deep_work'],
        ['p4d-tutor', 'Tutoring session', wd(-4, 6), wd(-4, 7), 'meeting'],
        ['p3b-class2', 'Algorithms Lecture', wd(-3, 1), wd(-3, 2, 30), 'meeting'],
        ['p3c-assign2', 'Assignment writing block', wd(-3, 3), wd(-3, 5, 30), 'deep_work'],
        ['p3d-hackathon', 'Hackathon coding session', wd(-3, 7), wd(-3, 10), 'deep_work'],
        ['p2b-class3', 'Software Engineering Lecture', wd(-2, 1), wd(-2, 2, 30), 'meeting'],
        ['p2c-cert3', 'Certification lab practice', wd(-2, 3), wd(-2, 5), 'deep_work'],
        ['p2d-parttime3', 'Part-time Work Shift', wd(-2, 6), wd(-2, 9), 'other'],
        ['p1b-hack-final', 'Hackathon final sprint', wd(-1, 3), wd(-1, 6), 'deep_work'],
        ['p1c-review', 'Team project code review', wd(-1, 7), wd(-1, 8), 'meeting'],
        ['p1d-rest', 'Evening recovery / rest', wd(-1, 13), wd(-1, 14), 'recovery'],
        // current-week extra (NOT day 2 Wednesday, careful with day 3 Thursday)
        ['mon-cert-extra', 'Certification study block', wd(0, 6), wd(0, 8), 'deep_work'],
        ['tue-assign-extra', 'Assignment deep work', wd(1, 6), wd(1, 9), 'deep_work'],
        ['fri-cert-examday', 'Certification Exam Day', wd(4, 2), wd(4, 6), 'deadline'],
      ];
      for (const event of additionalEvents) addCalendar(...event);
      ...
      const additionalEvents: Parameters<typeof addCalendar>[] = [
        ...
        // Extra past-day density: 30 more events → total 90
        ['p7b-lecture', 'Undergraduate Lecture (Monday)', wd(-7, 2), wd(-7, 4), 'meeting'],
        ['p7c-grade', 'Grading session', wd(-7, 5), wd(-7, 7), 'deep_work'],
        ['p7d-office', 'Office Hours', wd(-7, 7, 30), wd(-7, 9), 'other'],
        ['p7e-research', 'Research writing', wd(-7, 9), wd(-7, 10, 30), 'deep_work'],
        ['p6b-lecture2', 'Postgraduate Seminar', wd(-6, 2), wd(-6, 4), 'meeting'],
        ['p6c-committee', 'Committee Prep', wd(-6, 5), wd(-6, 6), 'meeting'],
        ['p6d-grade2', 'Grading assignments', wd(-6, 7), wd(-6, 9), 'deep_work'],
        ['p5b-lecture3', 'Undergraduate Tutorial', wd(-5, 2), wd(-5, 4), 'meeting'],
        ['p5c-confprep', 'Conference abstract writing', wd(-5, 5), wd(-5, 7), 'deep_work'],
        ['p5d-office2', 'Student Office Hours', wd(-5, 7, 30), wd(-5, 9), 'other'],
        ['p4b-teaching', 'Lecture Delivery', wd(-4, 2), wd(-4, 4), 'meeting'],
        ['p4c-grade3', 'Batch grading', wd(-4, 5), wd(-4, 7), 'deep_work'],
        ['p4d-faculty', 'Faculty meeting', wd(-4, 7, 30), wd(-4, 9), 'meeting'],
        ['p3b-lecture4', 'Research Methods Lecture', wd(-3, 2), wd(-3, 4), 'meeting'],
        ['p3c-writing', 'Conference paper draft', wd(-3, 5), wd(-3, 7, 30), 'deep_work'],
        ['p3d-office3', 'PhD student meeting', wd(-3, 8), wd(-3, 9), 'meeting'],
        ['p2b-lecture5', 'Undergraduate Lecture', wd(-2, 2), wd(-2, 4), 'meeting'],
        ['p2c-grade4', 'Grading mid-term papers', wd(-2, 5), wd(-2, 7, 30), 'deep_work'],
        ['p2d-conf', 'Conference Call (Guest Speaker)', wd(-2, 8), wd(-2, 9), 'meeting'],
        ['p1b-lecture6', 'Tutorial Session', wd(-1, 2), wd(-1, 4), 'meeting'],
        ['p1c-grade5', 'Final grading round', wd(-1, 5), wd(-1, 7), 'deep_work'],
        ['p1d-research2', 'Literature review', wd(-1, 8), wd(-1, 10), 'deep_work'],
        // current-week extra
        ['mon-grade6', 'Grading block (morning)', wd(0, 3), wd(0, 5), 'deep_work'],
        ['tue-research3', 'Research deep work', wd(1, 3), wd(1, 5, 30), 'deep_work'],
        ['wed-confprep2', 'Conference Prep (Tentative)', wd(2, 5), wd(2, 7), 'other', undefined, 'TENTATIVE'],
        ['fri-grade7', 'Final grade submission', wd(4, 5), wd(4, 7), 'deadline'],
        ['sat-writing', 'Weekend research writing', wd(5, 1), wd(5, 4), 'deep_work'],
        ['sun-rest', 'Rest and recovery', wd(6, 0), wd(6, 2), 'recovery'],
        ['d8-conf', 'Guest lecture prep', wd(8, 3), wd(8, 5), 'other'],
      ];
      for (const event of additionalEvents) addCalendar(...event);
    } else {
      ...
      const additionalEvents: Parameters<typeof addCalendar>[] = [
        ...
        // Extra past-day density: 35 more events → total 100
        ['p7b-teaching', 'Undergraduate Teaching (3h)', wd(-7, 2), wd(-7, 5), 'meeting', undefined, 'CONFIRMED', { flexibility: 'FIXED', priority: 'HIGH', consequence: 'HIGH' }],
        ['p7c-proposal', 'Proposal Writing Block', wd(-7, 6), wd(-7, 8, 30), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'proposal' }],
        ['p7d-office', 'Student Office Hours', wd(-7, 8, 30), wd(-7, 10), 'other'],
        ['p7e-dept', 'Dept Admin (Movable)', wd(-7, 10), wd(-7, 11), 'meeting', undefined, 'CONFIRMED', { flexibility: 'MOVABLE', priority: 'LOW', consequence: 'LOW' }],
        ['p6b-tutorial', 'Tutorial Session', wd(-6, 2), wd(-6, 4), 'meeting', undefined, 'CONFIRMED', { flexibility: 'FIXED', priority: 'HIGH', consequence: 'HIGH' }],
        ['p6c-research', 'Literature Review deep work', wd(-6, 5), wd(-6, 7), 'deep_work'],
        ['p6d-meeting', 'Department Meeting (Movable)', wd(-6, 7, 30), wd(-6, 8, 30), 'meeting', undefined, 'CONFIRMED', { flexibility: 'MOVABLE', priority: 'LOW', consequence: 'LOW' }],
        ['p5b-lecture', 'Research Seminar Teaching', wd(-5, 2), wd(-5, 4), 'meeting', undefined, 'CONFIRMED', { flexibility: 'FIXED', priority: 'HIGH', consequence: 'HIGH' }],
        ['p5c-proposal2', 'Proposal Writing Session', wd(-5, 5), wd(-5, 7, 30), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'proposal' }],
        ['p5d-supervisor', 'PhD Supervision', wd(-5, 8), wd(-5, 9), 'meeting'],
        ['p4b-teaching2', 'Undergraduate Lecture', wd(-4, 2), wd(-4, 4, 30), 'meeting', undefined, 'CONFIRMED', { flexibility: 'FIXED', priority: 'HIGH', consequence: 'HIGH' }],
        ['p4c-proposal3', 'Proposal revision', wd(-4, 5), wd(-4, 7), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'proposal' }],
        ['p4d-admin', 'Faculty Committee (Movable)', wd(-4, 7, 30), wd(-4, 9), 'meeting', undefined, 'CONFIRMED', { flexibility: 'MOVABLE', priority: 'LOW', consequence: 'LOW' }],
        ['p4e-research2', 'Data analysis block', wd(-4, 9, 30), wd(-4, 11), 'deep_work'],
        ['p3b-teaching3', 'Tutorial + Q&A', wd(-3, 2), wd(-3, 4), 'meeting', undefined, 'CONFIRMED', { flexibility: 'FIXED', priority: 'HIGH', consequence: 'HIGH' }],
        ['p3c-writing', 'Proposal Writing', wd(-3, 5), wd(-3, 7, 30), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'proposal' }],
        ['p3d-collab', 'Research Collaboration Meeting', wd(-3, 8), wd(-3, 9), 'meeting', undefined, 'CONFIRMED', { linkedGoalId: 'workshop' }],
        ['p2b-teaching4', 'Undergraduate Lecture', wd(-2, 2), wd(-2, 4, 30), 'meeting', undefined, 'CONFIRMED', { flexibility: 'FIXED', priority: 'HIGH', consequence: 'HIGH' }],
        ['p2c-proposal4', 'Proposal final draft', wd(-2, 5), wd(-2, 7, 30), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'proposal' }],
        ['p2d-dept2', 'Departmental Planning (Movable)', wd(-2, 8), wd(-2, 9), 'meeting', undefined, 'CONFIRMED', { flexibility: 'MOVABLE', priority: 'LOW', consequence: 'LOW' }],
        ['p1b-tutorial2', 'Tutorial Session', wd(-1, 2), wd(-1, 4), 'meeting', undefined, 'CONFIRMED', { flexibility: 'FIXED', priority: 'HIGH', consequence: 'HIGH' }],
        ['p1c-proposal5', 'Proposal polish block', wd(-1, 5), wd(-1, 7, 30), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'proposal' }],
        ['p1d-office2', 'Student consultations', wd(-1, 8), wd(-1, 9, 30), 'other'],
        // current-week extra
        ['mon-research3', 'Data analysis', wd(0, 6), wd(0, 8), 'deep_work'],
        ['tue-office3', 'Open office hours', wd(1, 8), wd(1, 9), 'other'],
        ['wed-proposal6', 'Proposal final review', wd(2, 5), wd(2, 7), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'proposal' }],
        ['sat-writing2', 'Weekend proposal polish', wd(5, 1), wd(5, 4), 'deep_work', undefined, 'CONFIRMED', { linkedGoalId: 'proposal' }],
        ['sun-background', 'Background reading', wd(6, 0), wd(6, 2), 'deep_work'],
        ['d8-workshop2', 'Research workshop planning', wd(8, 3), wd(8, 5), 'other'],
        ['d9-admin', 'Faculty Admin (Movable)', wd(9, 2), wd(9, 4), 'meeting', undefined, 'CONFIRMED', { flexibility: 'MOVABLE', priority: 'LOW', consequence: 'LOW' }],
      ];
      for (const event of additionalEvents) addCalendar(...event);
    }
  }
